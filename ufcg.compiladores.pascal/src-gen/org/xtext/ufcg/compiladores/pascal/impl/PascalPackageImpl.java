...
public class PascalPackageImpl extends EPackageImpl implements PascalPackage
{
   ...
   * @generated
   */
  public EReference getstructured_statement_With_stt()
  {
   ...
   * @generated
   */
  public EReference getcompound_statement_Stmt_seq()
  {
   ...
   * @generated
   */
  public EReference getrepetitive_statement_While()
  {
   ...
   * @generated
   */
  public EReference getrepetitive_statement_Repeat()
  {
   ...
   * @generated
   */
  public EReference getrepetitive_statement_For()
  {
   ...
   * @generated
   */
  public EReference getrepeat_statement_Stmt_seq()
  {
   ...
   * @generated
   */
  public EAttribute getfor_statement_InitID()
  {
   ...
   * @generated
   */
  public EReference getfor_statement_ExpressionInit()
  {
   ...
   * @generated
   */
  public EReference getfor_statement_ExpressionFin()
  {
   ...
   * @generated
   */
  public EReference getfor_statement_Stmt()
  {
   ...
   * @generated
   */
  public EAttribute getwith_statement_Record()
  {
    return (EAttribute)with_statementEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getwith_statement_Records()
  {
    return (EAttribute)with_statementEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getwith_statement_Stmt()
  {
    return (EReference)with_statementEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(structured_statementEClass, STRUCTURED_STATEMENT__WITH_STT);

    compound_statementEClass = createEClass(COMPOUND_STATEMENT);
    createEReference(compound_statementEClass, COMPOUND_STATEMENT__STMT_SEQ);

    repetitive_statementEClass = createEClass(REPETITIVE_STATEMENT);
    createEReference(repetitive_statementEClass, REPETITIVE_STATEMENT__WHILE);
    createEReference(repetitive_statementEClass, REPETITIVE_STATEMENT__REPEAT);
    createEReference(repetitive_statementEClass, REPETITIVE_STATEMENT__FOR);
    ...
    createEReference(repeat_statementEClass, REPEAT_STATEMENT__STMT_SEQ);
    createEReference(repeat_statementEClass, REPEAT_STATEMENT__EXPRESSION);

    for_statementEClass = createEClass(FOR_STATEMENT);
    createEAttribute(for_statementEClass, FOR_STATEMENT__INIT_ID);
    createEReference(for_statementEClass, FOR_STATEMENT__EXPRESSION_INIT);
    createEReference(for_statementEClass, FOR_STATEMENT__EXPRESSION_FIN);
    createEReference(for_statementEClass, FOR_STATEMENT__STMT);
    ...
    createEAttribute(with_statementEClass, WITH_STATEMENT__RECORDS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getstructured_statement_With_stt(), this.getwith_statement(), null, "with_stt", null, 0, 1, structured_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getcompound_statement_Stmt_seq(), this.getstatement_sequence(), null, "stmt_seq", null, 0, 1, compound_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getrepetitive_statement_While(), this.getwhile_statement(), null, "while", null, 0, 1, repetitive_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getrepetitive_statement_Repeat(), this.getrepeat_statement(), null, "repeat", null, 0, 1, repetitive_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getrepetitive_statement_For(), this.getfor_statement(), null, "for", null, 0, 1, repetitive_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getrepeat_statement_Stmt_seq(), this.getstatement_sequence(), null, "stmt_seq", null, 0, 1, repeat_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getfor_statement_InitID(), ecorePackage.getEString(), "initID", null, 0, 1, for_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getfor_statement_ExpressionInit(), this.getexpression(), null, "expressionInit", null, 0, 1, for_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getfor_statement_ExpressionFin(), this.getexpression(), null, "expressionFin", null, 0, 1, for_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getfor_statement_Stmt(), this.getstatement(), null, "stmt", null, 0, 1, for_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getwith_statement_Records(), ecorePackage.getEString(), "records", null, 0, -1, with_statement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
