...
public interface PascalFactory extends EFactory
{
   ...
   * @generated
   */
  PascalFactory eINSTANCE = org.xtext.ufcg.compiladores.pascal.impl.PascalFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>resto</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>resto</em>'.
   * @generated
   */
  resto createresto();
